...
import com.network.clever.data.repository.item.MyPlaylistRepository
...
@Inject
constructor(private val repository: MyPlaylistRepository) : BaseUseCase<Params, Resource>() {
    ...
    override suspend fun execute(
        ...
        return repository.work(this@MyPlaylistUseCase.liveData)
    }
